...
const u8 *const gMonIconTable[] =
{
    ...
    [SPECIES_SHELLOSWESTSEA] = gMonIcon_ShellosWestSea,
    [SPECIES_SHELLOSEAST] = gMonIcon_ShellosEast,
    [SPECIES_GASTRODONWESTSEA] = gMonIcon_GastrodonWestSea,
...
const u8 gMonIconPaletteIndices[] =
{
    ...
    [SPECIES_SHELLOSWESTSEA] = 0,
    [SPECIES_SHELLOSEAST] = 0,
    [SPECIES_GASTRODONWESTSEA] = 0,
    ...
    [SPECIES_BRONZONG] = 0,
    [SPECIES_CHATOT] = 0,
    // TODO: Figure out palette index 5
    [SPECIES_SPIRITOMB] = 2,
    [SPECIES_GIBLE] = 0,
    [SPECIES_GABITE] = 0,
    [SPECIES_GARCHOMP] = 0,
    ...
    // TODO: Figure out Arceus palette
    [SPECIES_ARCEUS] = 1,
    [SPECIES_EGG] = 1,
    [SPECIES_UNOWN_B] = 0,
    [SPECIES_UNOWN_C] = 0,
