...
#define SPECIES_TO_SINNOH_FORM(name, alias)   [SPECIES_##name - 1] = SINNOH_DEX_##alias
#define SPECIES_TO_NATIONAL_FORM(name, alias) [SPECIES_##name - 1] = NATIONAL_DEX_##alias
...
static const u16 sSpeciesToSinnohPokedexNum[NUM_SPECIES - 1] =
{
    ...
    SPECIES_TO_SINNOH(ROSERADE),
    SPECIES_TO_SINNOH(CRANIDOS),
    SPECIES_TO_SINNOH(RAMPARDOS),
    SPECIES_TO_SINNOH(SHIELDON),
    SPECIES_TO_SINNOH(BASTIODON),
    SPECIES_TO_SINNOH(BURMYPLANT),
    SPECIES_TO_SINNOH_FORM(BURMYSANDY, BURMYPLANT),
    SPECIES_TO_SINNOH_FORM(BURMYTRASH, BURMYPLANT),
    SPECIES_TO_SINNOH(WORMADAMPLANT),
    SPECIES_TO_SINNOH_FORM(WORMADAMSANDY, WORMADAMPLANT),
    SPECIES_TO_SINNOH_FORM(WORMADAMTRASH, WORMADAMPLANT),
    ...
    // SPECIES_TO_SINNOH(CHERRIMOVERCAST),
    // SPECIES_TO_SINNOH_FORM(CHERRIMSUNSHINE, CHERRIMOVERCAST),
    SPECIES_TO_SINNOH(SHELLOSWEST),
    SPECIES_TO_SINNOH_FORM(SHELLOSEAST, SHELLOSWEST),
    SPECIES_TO_SINNOH(GASTRODONWEST),
    SPECIES_TO_SINNOH_FORM(GASTRODONEAST, GASTRODONWEST),
    ...
    SPECIES_TO_SINNOH_FORM(HIPPOPOTASF, HIPPOPOTAS),
    SPECIES_TO_SINNOH(HIPPOWDON),
    SPECIES_TO_SINNOH_FORM(HIPPOWDONF, HIPPOWDON),
    ...
    // SPECIES_TO_SINNOH_FORM(ROTOMHEAT, ROTOM),
    // SPECIES_TO_SINNOH_FORM(ROTOMWASH, ROTOM),
    // SPECIES_TO_SINNOH_FORM(ROTOMFROST, ROTOM),
    // SPECIES_TO_SINNOH_FORM(ROTOMFAN, ROTOM),
    // SPECIES_TO_SINNOH_FORM(ROTOMMOW, ROTOM),
    SPECIES_TO_SINNOH(UXIE),
    SPECIES_TO_SINNOH(MESPRIT),
    SPECIES_TO_SINNOH(AZELF),
    SPECIES_TO_SINNOH(DIALGA),
    SPECIES_TO_SINNOH(PALKIA),
    SPECIES_TO_SINNOH(HEATRAN),
    SPECIES_TO_SINNOH(REGIGIGAS),
    SPECIES_TO_SINNOH(GIRATINA),
    // SPECIES_TO_SINNOH(GIRATINAALTERED),
    // SPECIES_TO_SINNOH_FORM(GIRATINAORIGIN, GIRATINAALTERED),
    SPECIES_TO_SINNOH(CRESSELIA),
    SPECIES_TO_SINNOH(PHIONE),
    SPECIES_TO_SINNOH(MANAPHY),
    SPECIES_TO_SINNOH(DARKRAI),
    SPECIES_TO_SINNOH(SHAYMIN),
    // SPECIES_TO_SINNOH(SHAYMINLAND),
    // SPECIES_TO_SINNOH_FORM(SHAYMINSKY, SHAYMINLAND),
    SPECIES_TO_SINNOH(ARCEUS),
    // SPECIES_TO_SINNOH(ARCEUSNORMAL),
    // SPECIES_TO_SINNOH_FORM(ARCEUSFIGHTING, ARCEUSNORMAL),
    // SPECIES_TO_SINNOH_FORM(ARCEUSFLYING, ARCEUSNORMAL),
    // SPECIES_TO_SINNOH_FORM(ARCEUSPOISON, ARCEUSNORMAL),
    // SPECIES_TO_SINNOH_FORM(ARCEUSGROUND, ARCEUSNORMAL),
    // SPECIES_TO_SINNOH_FORM(ARCEUSROCK, ARCEUSNORMAL),
    // SPECIES_TO_SINNOH_FORM(ARCEUSBUG, ARCEUSNORMAL),
    // SPECIES_TO_SINNOH_FORM(ARCEUSGHOST, ARCEUSNORMAL),
    // SPECIES_TO_SINNOH_FORM(ARCEUSSTEEL, ARCEUSNORMAL),
    // SPECIES_TO_SINNOH_FORM(ARCEUSFIRE, ARCEUSNORMAL),
    // SPECIES_TO_SINNOH_FORM(ARCEUSWATER, ARCEUSNORMAL),
    // SPECIES_TO_SINNOH_FORM(ARCEUSGRASS, ARCEUSNORMAL),
    // SPECIES_TO_SINNOH_FORM(ARCEUSELECTRIC, ARCEUSNORMAL),
    // SPECIES_TO_SINNOH_FORM(ARCEUSPSYCHIC, ARCEUSNORMAL),
    // SPECIES_TO_SINNOH_FORM(ARCEUSICE, ARCEUSNORMAL),
    // SPECIES_TO_SINNOH_FORM(ARCEUSDRAGON, ARCEUSNORMAL),
    // SPECIES_TO_SINNOH_FORM(ARCEUSDARK, ARCEUSNORMAL),
};
...
static const u16 sSpeciesToNationalPokedexNum[NUM_SPECIES - 1] =
{
    ...
    SPECIES_TO_NATIONAL(BURMYPLANT),
    SPECIES_TO_NATIONAL_FORM(BURMYSANDY, BURMYPLANT),
    SPECIES_TO_NATIONAL_FORM(BURMYTRASH, BURMYPLANT),
    SPECIES_TO_NATIONAL(WORMADAMPLANT),
    SPECIES_TO_NATIONAL_FORM(WORMADAMSANDY, WORMADAMPLANT),
    SPECIES_TO_NATIONAL_FORM(WORMADAMTRASH, WORMADAMPLANT),
    ...
    // SPECIES_TO_NATIONAL(CHERRIMOVERCAST),
    // SPECIES_TO_NATIONAL_FORM(CHERRIMSUNSHINE, CHERRIMOVERCAST),
    SPECIES_TO_NATIONAL(SHELLOSWEST),
    SPECIES_TO_NATIONAL_FORM(SHELLOSEAST, SHELLOSWEST),
    SPECIES_TO_NATIONAL(GASTRODONWEST),
    SPECIES_TO_NATIONAL_FORM(GASTRODONEAST, GASTRODONWEST),
    ...
    SPECIES_TO_NATIONAL_FORM(HIPPOPOTASF, HIPPOPOTAS),
    SPECIES_TO_NATIONAL(HIPPOWDON),
    SPECIES_TO_NATIONAL_FORM(HIPPOWDONF, HIPPOWDON),
    ...
    // SPECIES_TO_NATIONAL_FORM(ROTOMHEAT, ROTOM),
    // SPECIES_TO_NATIONAL_FORM(ROTOMWASH, ROTOM),
    // SPECIES_TO_NATIONAL_FORM(ROTOMFROST, ROTOM),
    // SPECIES_TO_NATIONAL_FORM(ROTOMFAN, ROTOM),
    // SPECIES_TO_NATIONAL_FORM(ROTOMMOW, ROTOM),
    ...
    // SPECIES_TO_NATIONAL(GIRATINAALTERED),
    // SPECIES_TO_NATIONAL_FORM(GIRATINAORIGIN, GIRATINAALTERED),
    ...
    // SPECIES_TO_NATIONAL(SHAYMINLAND),
    // SPECIES_TO_NATIONAL_FORM(SHAYMINSKY, SHAYMINLAND),
    SPECIES_TO_NATIONAL(ARCEUS),
    // SPECIES_TO_NATIONAL(ARCEUSNORMAL),
    // SPECIES_TO_NATIONAL_FORM(ARCEUSFIGHTING, ARCEUSNORMAL),
    // SPECIES_TO_NATIONAL_FORM(ARCEUSFLYING, ARCEUSNORMAL),
    // SPECIES_TO_NATIONAL_FORM(ARCEUSPOISON, ARCEUSNORMAL),
    // SPECIES_TO_NATIONAL_FORM(ARCEUSGROUND, ARCEUSNORMAL),
    // SPECIES_TO_NATIONAL_FORM(ARCEUSROCK, ARCEUSNORMAL),
    // SPECIES_TO_NATIONAL_FORM(ARCEUSBUG, ARCEUSNORMAL),
    // SPECIES_TO_NATIONAL_FORM(ARCEUSGHOST, ARCEUSNORMAL),
    // SPECIES_TO_NATIONAL_FORM(ARCEUSSTEEL, ARCEUSNORMAL),
    // SPECIES_TO_NATIONAL_FORM(ARCEUSFIRE, ARCEUSNORMAL),
    // SPECIES_TO_NATIONAL_FORM(ARCEUSWATER, ARCEUSNORMAL),
    // SPECIES_TO_NATIONAL_FORM(ARCEUSGRASS, ARCEUSNORMAL),
    // SPECIES_TO_NATIONAL_FORM(ARCEUSELECTRIC, ARCEUSNORMAL),
    // SPECIES_TO_NATIONAL_FORM(ARCEUSPSYCHIC, ARCEUSNORMAL),
    // SPECIES_TO_NATIONAL_FORM(ARCEUSICE, ARCEUSNORMAL),
    // SPECIES_TO_NATIONAL_FORM(ARCEUSDRAGON, ARCEUSNORMAL),
    // SPECIES_TO_NATIONAL_FORM(ARCEUSDARK, ARCEUSNORMAL),
};

// Assigns all Sinnoh Dex Indexes to a National Dex Index
static const u16 sSinnohToNationalOrder[NUM_SPECIES - 1] =
{
    SINNOH_TO_NATIONAL(BULBASAUR),
...
s32 CalculateBaseDamage(struct BattlePokemon *attacker, struct BattlePokemon *defender, u32 move, u16 sideStatus, u16 powerOverride, u8 typeOverride, u8 battlerIdAtk, u8 battlerIdDef)
{
    ...
    // Def/SpDef boost in Sandstorm/Hail
    if ((gBattleWeather & B_WEATHER_HAIL) && IS_BATTLER_OF_TYPE(gBattlerTarget, TYPE_ICE))
        defense *= 1.5;
    if ((gBattleWeather & B_WEATHER_SANDSTORM) && IS_BATTLER_OF_TYPE(gBattlerTarget, TYPE_ROCK))
        spDefense *= 1.5;
    ...
    if (IS_TYPE_PHYSICAL(type))
    {
        ...
        // Moves hitting both targets do a quarter damage in double battles
