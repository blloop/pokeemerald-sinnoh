...
const union AnimCmd gMetronomeThoughtBubbleAnimCmds1[] =
{
...
const union AnimCmd gMetronomeThoughtBubbleAnimCmds3[] =
{
    ANIMCMD_FRAME(48, 2, .hFlip = TRUE),
    ANIMCMD_FRAME(32, 2, .hFlip = TRUE),
    ANIMCMD_FRAME(16, 2, .hFlip = TRUE),
...
const union AnimCmd gMetronomeThoughtBubbleAnimCmds2[] =
{
    ANIMCMD_FRAME(0, 2),
    ANIMCMD_FRAME(16, 2),
    ANIMCMD_FRAME(32, 2),
...
const union AnimCmd gMetronomeThoughtBubbleAnimCmds4[] =
{
    ANIMCMD_FRAME(48, 2),
    ANIMCMD_FRAME(32, 2),
    ANIMCMD_FRAME(16, 2),
...
const union AnimCmd *const gMetronomeThoughtBubbleAnimTable[] =
{
    gMetronomeThoughtBubbleAnimCmds1,
    gMetronomeThoughtBubbleAnimCmds2,
    gMetronomeThoughtBubbleAnimCmds3,
    gMetronomeThoughtBubbleAnimCmds4,
};
...
const struct SpriteTemplate gThoughtBubbleSpriteTemplate =
{
    ...
    .oam = &gOamData_AffineOff_ObjNormal_32x32,
    .anims = gMetronomeThoughtBubbleAnimTable,
    .images = NULL,
    .affineAnims = gDummySpriteAffineAnimTable,
