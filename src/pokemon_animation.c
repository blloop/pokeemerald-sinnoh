...
static const u8 sSpeciesToBackAnimSet[] =
{
    ...
    [SPECIES_TURTWIG]         = BACK_ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_GROTLE]          = BACK_ANIM_V_STRETCH,
    [SPECIES_TORTERRA]        = BACK_ANIM_H_SHAKE,
    [SPECIES_CHIMCHAR]        = BACK_ANIM_V_JUMPS_BIG,
    [SPECIES_MONFERNO]        = BACK_ANIM_H_JUMPS_V_STRETCH,
    [SPECIES_INFERNAPE]       = BACK_ANIM_V_STRETCH,
    [SPECIES_PIPLUP]          = BACK_ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_PRINPLUP]        = BACK_ANIM_V_STRETCH,
    [SPECIES_EMPOLEON]        = BACK_ANIM_V_STRETCH,
    [SPECIES_STARLY]          = BACK_ANIM_V_STRETCH,
    [SPECIES_STARAVIA]        = BACK_ANIM_V_STRETCH,
    [SPECIES_STARAPTOR]       = BACK_ANIM_V_SHAKE,
    [SPECIES_BIDOOF]          = BACK_ANIM_H_SLIDE_SLOW,
    [SPECIES_BIBAREL]         = BACK_ANIM_GROW_VIBRATE,
    [SPECIES_KRICKETOT]       = BACK_ANIM_H_JUMPS,
    [SPECIES_KRICKETUNE]      = BACK_ANIM_H_SLIDE_SLOW,
    [SPECIES_SHINX]           = BACK_ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_LUXIO]           = BACK_ANIM_H_STRETCH,
    [SPECIES_LUXRAY]          = BACK_ANIM_GLOW_YELLOW,
    [SPECIES_BUDEW]           = BACK_ANIM_CONCAVE_ARC_SMALL,
    [SPECIES_ROSERADE]        = BACK_ANIM_SHRINK_GROW_VIBRATE,
    [SPECIES_CRANIDOS]        = BACK_ANIM_V_STRETCH,
    [SPECIES_RAMPARDOS]       = BACK_ANIM_V_SHAKE_TWICE,
    [SPECIES_SHIELDON]        = BACK_ANIM_V_SHAKE,
    [SPECIES_BASTIODON]       = BACK_ANIM_BACK_AND_LUNGE,
    [SPECIES_BURMYPLANT]      = BACK_ANIM_V_STRETCH,
    [SPECIES_BURMYSANDY]      = BACK_ANIM_V_STRETCH,
    [SPECIES_BURMYTRASH]      = BACK_ANIM_V_STRETCH,
    [SPECIES_WORMADAMPLANT]   = BACK_ANIM_SWING_CONVEX_FAST_SHORT,
    [SPECIES_WORMADAMSANDY]   = BACK_ANIM_SWING_CONVEX_FAST_SHORT,
    [SPECIES_WORMADAMTRASH]   = BACK_ANIM_SWING_CONVEX_FAST_SHORT,
    [SPECIES_MOTHIM]          = BACK_ANIM_H_SLIDE_WOBBLE,
    [SPECIES_COMBEE]          = BACK_ANIM_V_SLIDE_WOBBLE,
    [SPECIES_VESPIQUEN]       = BACK_ANIM_LUNGE_GROW,
    [SPECIES_PACHIRISU]       = BACK_ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_BUIZEL]          = BACK_ANIM_GROW_VIBRATE,
    [SPECIES_FLOATZEL]        = BACK_ANIM_H_JUMPS_V_STRETCH,
    [SPECIES_CHERUBI]         = BACK_ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_CHERRIM]         = BACK_ANIM_DEEP_V_SQUISH_AND_BOUNCE,
    // [SPECIES_CHERRIMOVERCAST] = BACK_ANIM_DEEP_V_SQUISH_AND_BOUNCE,
    // [SPECIES_CHERRIMSUNSHINE] = BACK_ANIM_H_JUMPS_V_STRETCH,
    [SPECIES_SHELLOSWEST]     = BACK_ANIM_V_STRETCH,
    [SPECIES_SHELLOSEAST]     = BACK_ANIM_V_STRETCH,
    [SPECIES_GASTRODONWEST]   = BACK_ANIM_CIRCULAR_STRETCH_TWICE,
    [SPECIES_GASTRODONEAST]   = BACK_ANIM_CIRCULAR_STRETCH_TWICE,
    [SPECIES_AMBIPOM]         = BACK_ANIM_CONCAVE_ARC_LARGE,
    [SPECIES_DRIFLOON]        = BACK_ANIM_V_SLIDE_WOBBLE,
    [SPECIES_DRIFBLIM]        = BACK_ANIM_V_SLIDE_WOBBLE,
    [SPECIES_BUNEARY]         = BACK_ANIM_H_JUMPS_V_STRETCH,
    [SPECIES_LOPUNNY]         = BACK_ANIM_SHRINK_GROW,
    [SPECIES_MISMAGIUS]       = BACK_ANIM_CONVEX_DOUBLE_ARC,
    [SPECIES_HONCHKROW]       = BACK_ANIM_H_STRETCH,
    [SPECIES_GLAMEOW]         = BACK_ANIM_GROW_VIBRATE,
    [SPECIES_PURUGLY]         = BACK_ANIM_V_STRETCH,
    [SPECIES_CHINGLING]       = BACK_ANIM_CONCAVE_ARC_SMALL,
    [SPECIES_STUNKY]          = BACK_ANIM_TIP_MOVE_FORWARD,
    [SPECIES_SKUNTANK]        = BACK_ANIM_V_SQUISH_AND_BOUNCE_SLOW,
    [SPECIES_BRONZOR]         = BACK_ANIM_H_SLIDE_WOBBLE,
    [SPECIES_BRONZONG]        = BACK_ANIM_V_SLIDE_WOBBLE_SMALL,
    [SPECIES_BONSLY]          = BACK_ANIM_H_VIBRATE,
    [SPECIES_MIMEJR]          = BACK_ANIM_CONCAVE_ARC_LARGE,
    [SPECIES_HAPPINY]         = BACK_ANIM_CONCAVE_ARC_SMALL,
    [SPECIES_CHATOT]          = BACK_ANIM_V_SHAKE_TWICE,
    [SPECIES_SPIRITOMB]       = BACK_ANIM_GROW_IN_STAGES,
    [SPECIES_GIBLE]           = BACK_ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_GABITE]          = BACK_ANIM_V_STRETCH,
    [SPECIES_GARCHOMP]        = BACK_ANIM_V_SHAKE_TWICE,
    [SPECIES_MUNCHLAX]        = BACK_ANIM_GROW,
    [SPECIES_RIOLU]           = BACK_ANIM_RAPID_H_HOPS,
    [SPECIES_LUCARIO]         = BACK_ANIM_V_STRETCH,
    [SPECIES_HIPPOPOTAS]      = BACK_ANIM_V_STRETCH,
    [SPECIES_HIPPOPOTASF]     = BACK_ANIM_V_STRETCH,
    [SPECIES_HIPPOWDON]       = BACK_ANIM_V_SHAKE_TWICE,
    [SPECIES_HIPPOWDONF]      = BACK_ANIM_V_SHAKE_TWICE,
    [SPECIES_SKORUPI]         = BACK_ANIM_H_SLIDE_SLOW,
    [SPECIES_DRAPION]         = BACK_ANIM_V_JUMPS_BIG,
    [SPECIES_CROAGUNK]        = BACK_ANIM_RAPID_H_HOPS,
    [SPECIES_TOXICROAK]       = BACK_ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_CARNIVINE]       = BACK_ANIM_FIGURE_8,
    [SPECIES_FINNEON]         = BACK_ANIM_V_SLIDE_WOBBLE_SMALL,
    [SPECIES_LUMINEON]        = BACK_ANIM_H_STRETCH,
    [SPECIES_MANTYKE]         = BACK_ANIM_CONVEX_DOUBLE_ARC,
    [SPECIES_SNOVER]          = BACK_ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_ABOMASNOW]       = BACK_ANIM_H_SHAKE,
    ...
    [SPECIES_ROTOM]           = BACK_ANIM_GLOW_YELLOW,
    // [SPECIES_ROTOMHEAT]       = BACK_ANIM_V_SQUISH_AND_BOUNCE,
    // [SPECIES_ROTOMWASH]       = BACK_ANIM_V_JUMPS_SMALL,
    // [SPECIES_ROTOMFROST]      = BACK_ANIM_H_STRETCH,
    // [SPECIES_ROTOMFAN]        = BACK_ANIM_H_SLIDE_WOBBLE,
    // [SPECIES_ROTOMMOW]        = BACK_ANIM_TIP_MOVE_FORWARD,
    [SPECIES_UXIE]            = BACK_ANIM_SWING_CONCAVE,
    [SPECIES_MESPRIT]         = BACK_ANIM_H_SLIDE_WOBBLE,
    [SPECIES_AZELF]           = BACK_ANIM_V_SLIDE_WOBBLE,
    [SPECIES_DIALGA]          = BACK_ANIM_H_SHAKE,
    [SPECIES_PALKIA]          = BACK_ANIM_V_SHAKE,
    [SPECIES_HEATRAN]         = BACK_ANIM_GLOW_ORANGE,
    [SPECIES_REGIGIGAS]       = BACK_ANIM_V_SHAKE,
    [SPECIES_GIRATINA]        = BACK_ANIM_GROW_VIBRATE,
    // [SPECIES_GIRATINAALTERED] = BACK_ANIM_GROW_VIBRATE,
    // [SPECIES_GIRATINAORIGIN]  = BACK_ANIM_LUNGE_GROW,
    [SPECIES_CRESSELIA]       = BACK_ANIM_H_SLIDE_WOBBLE,
    [SPECIES_PHIONE]          = BACK_ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_MANAPHY]         = BACK_ANIM_SWING_CONVEX,
    [SPECIES_DARKRAI]         = BACK_ANIM_GLOW_BLACK,
    [SPECIES_SHAYMIN]         = BACK_ANIM_V_SQUISH_AND_BOUNCE,
    // [SPECIES_SHAYMINLAND]     = BACK_ANIM_V_SQUISH_AND_BOUNCE,
    // [SPECIES_SHAYMINSKY]      = BACK_ANIM_V_STRETCH,
    [SPECIES_ARCEUS]          = BACK_ANIM_GROW_VIBRATE,
    // [SPECIES_ARCEUSNORMAL]    = BACK_ANIM_GROW_VIBRATE,
    // [SPECIES_ARCEUSFIGHTING]  = BACK_ANIM_GROW_VIBRATE,
    // [SPECIES_ARCEUSFLYING]    = BACK_ANIM_GROW_VIBRATE,
    // [SPECIES_ARCEUSPOISON]    = BACK_ANIM_GROW_VIBRATE,
    // [SPECIES_ARCEUSGROUND]    = BACK_ANIM_GROW_VIBRATE,
    // [SPECIES_ARCEUSROCK]      = BACK_ANIM_GROW_VIBRATE,
    // [SPECIES_ARCEUSBUG]       = BACK_ANIM_GROW_VIBRATE,
    // [SPECIES_ARCEUSGHOST]     = BACK_ANIM_GROW_VIBRATE,
    // [SPECIES_ARCEUSSTEEL]     = BACK_ANIM_GROW_VIBRATE,
    // [SPECIES_ARCEUSFIRE]      = BACK_ANIM_GROW_VIBRATE,
    // [SPECIES_ARCEUSWATER]     = BACK_ANIM_GROW_VIBRATE,
    // [SPECIES_ARCEUSGRASS]     = BACK_ANIM_GROW_VIBRATE,
    // [SPECIES_ARCEUSELECTRIC]  = BACK_ANIM_GROW_VIBRATE,
    // [SPECIES_ARCEUSPSYCHIC]   = BACK_ANIM_GROW_VIBRATE,
    // [SPECIES_ARCEUSICE]       = BACK_ANIM_GROW_VIBRATE,
    // [SPECIES_ARCEUSDRAGON]    = BACK_ANIM_GROW_VIBRATE,
    // [SPECIES_ARCEUSDARK]      = BACK_ANIM_GROW_VIBRATE,
};
