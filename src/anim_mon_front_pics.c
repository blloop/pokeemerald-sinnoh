...
const u32 gMonFrontPic_Honchcrow[] = INCBIN_U32("graphics/pokemon/honchcrow/anim_front.4bpp.lz");
...
const u32 gMonFrontPic_Lickylicky[] = INCBIN_U32("graphics/pokemon/lickylicky/anim_front.4bpp.lz");
