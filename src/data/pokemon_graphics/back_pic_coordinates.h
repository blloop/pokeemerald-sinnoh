...
const struct MonCoords gMonBackPicCoords[] =
{
    ...
    [SPECIES_BURMYPLANT]      = { .size = MON_COORDS_SIZE(40, 56), .y_offset = 6  },
    [SPECIES_BURMYSANDY]      = { .size = MON_COORDS_SIZE(32, 56), .y_offset = 7  },
    [SPECIES_BURMYTRASH]      = { .size = MON_COORDS_SIZE(40, 64), .y_offset = 0  },
    [SPECIES_WORMADAMPLANT]   = { .size = MON_COORDS_SIZE(56, 64), .y_offset = 2  },
    [SPECIES_WORMADAMSANDY]   = { .size = MON_COORDS_SIZE(56, 64), .y_offset = 2  },
    [SPECIES_WORMADAMTRASH]   = { .size = MON_COORDS_SIZE(64, 64), .y_offset = 2  },
    ...
    // [SPECIES_CHERRIMOVERCAST] = { .size = MON_COORDS_SIZE(40, 56), .y_offset = 9  },
    // [SPECIES_CHERRIMSUNSHINE] = { .size = MON_COORDS_SIZE(64, 56), .y_offset = 6  },
    [SPECIES_SHELLOSWEST]     = { .size = MON_COORDS_SIZE(40, 56), .y_offset = 8  },
    [SPECIES_SHELLOSEAST]     = { .size = MON_COORDS_SIZE(56, 48), .y_offset = 8  },
    [SPECIES_GASTRODONWEST]   = { .size = MON_COORDS_SIZE(56, 64), .y_offset = 3  },
    [SPECIES_GASTRODONEAST]   = { .size = MON_COORDS_SIZE(56, 64), .y_offset = 3  },
    ...
    [SPECIES_MIMEJR]          = { .size = MON_COORDS_SIZE(64, 64), .y_offset = 1  },
    ...
    [SPECIES_HIPPOPOTASF]     = { .size = MON_COORDS_SIZE(64, 40), .y_offset = 14 },
    ...
    [SPECIES_PORYGONZ]        = { .size = MON_COORDS_SIZE(64, 56), .y_offset = 6  },
    ...
    // [SPECIES_ROTOMHEAT]       = { .size = MON_COORDS_SIZE(64, 40), .y_offset = 12 },
    // [SPECIES_ROTOMWASH]       = { .size = MON_COORDS_SIZE(64, 48), .y_offset = 11 },
    // [SPECIES_ROTOMFROST]      = { .size = MON_COORDS_SIZE(64, 56), .y_offset = 7  },
    // [SPECIES_ROTOMFAN]        = { .size = MON_COORDS_SIZE(64, 48), .y_offset = 8  },
    // [SPECIES_ROTOMMOW]        = { .size = MON_COORDS_SIZE(56, 48), .y_offset = 10 },
    ...
    // [SPECIES_GIRATINAALTERED] = { .size = MON_COORDS_SIZE(64, 64), .y_offset = 4  },
    // [SPECIES_GIRATINAORIGIN]  = { .size = MON_COORDS_SIZE(64, 56), .y_offset = 4  },
    ...
    // [SPECIES_SHAYMINLAND]     = { .size = MON_COORDS_SIZE(56, 40), .y_offset = 15 },
    // [SPECIES_SHAYMINSKY]      = { .size = MON_COORDS_SIZE(56, 64), .y_offset = 2  },
    [SPECIES_ARCEUS]          = { .size = MON_COORDS_SIZE(64, 64), .y_offset = 3  },
    // [SPECIES_ARCEUSNORMAL]    = { .size = MON_COORDS_SIZE(64, 64), .y_offset = 3  },
    // [SPECIES_ARCEUSFIGHTING]  = { .size = MON_COORDS_SIZE(64, 64), .y_offset = 3  },
    // [SPECIES_ARCEUSFLYING]    = { .size = MON_COORDS_SIZE(64, 64), .y_offset = 3  },
    // [SPECIES_ARCEUSPOISON]    = { .size = MON_COORDS_SIZE(64, 64), .y_offset = 3  },
    // [SPECIES_ARCEUSGROUND]    = { .size = MON_COORDS_SIZE(64, 64), .y_offset = 3  },
    // [SPECIES_ARCEUSROCK]      = { .size = MON_COORDS_SIZE(64, 64), .y_offset = 3  },
    // [SPECIES_ARCEUSBUG]       = { .size = MON_COORDS_SIZE(64, 64), .y_offset = 3  },
    // [SPECIES_ARCEUSGHOST]     = { .size = MON_COORDS_SIZE(64, 64), .y_offset = 3  },
    // [SPECIES_ARCEUSSTEEL]     = { .size = MON_COORDS_SIZE(64, 64), .y_offset = 3  },
    // [SPECIES_ARCEUSFIRE]      = { .size = MON_COORDS_SIZE(64, 64), .y_offset = 3  },
    // [SPECIES_ARCEUSWATER]     = { .size = MON_COORDS_SIZE(64, 64), .y_offset = 3  },
    // [SPECIES_ARCEUSGRASS]     = { .size = MON_COORDS_SIZE(64, 64), .y_offset = 3  },
    // [SPECIES_ARCEUSELECTRIC]  = { .size = MON_COORDS_SIZE(64, 64), .y_offset = 3  },
    // [SPECIES_ARCEUSPSYCHIC]   = { .size = MON_COORDS_SIZE(64, 64), .y_offset = 3  },
    // [SPECIES_ARCEUSICE]       = { .size = MON_COORDS_SIZE(64, 64), .y_offset = 3  },
    // [SPECIES_ARCEUSDRAGON]    = { .size = MON_COORDS_SIZE(64, 64), .y_offset = 3  },
    // [SPECIES_ARCEUSDARK]      = { .size = MON_COORDS_SIZE(64, 64), .y_offset = 3  },
