const struct CompressedSpritePalette gMonShinyPaletteTable[] =
{
    ...
    SPECIES_SHINY_PAL(BURMYPLANT, gMonShinyPalette_BurmyPlant),
    SPECIES_SHINY_PAL(BURMYSANDY, gMonShinyPalette_BurmySandy),
    SPECIES_SHINY_PAL(BURMYTRASH, gMonShinyPalette_BurmyTrash),
    SPECIES_SHINY_PAL(WORMADAMPLANT, gMonShinyPalette_WormadamPlant),
    SPECIES_SHINY_PAL(WORMADAMSANDY, gMonShinyPalette_WormadamSandy),
    SPECIES_SHINY_PAL(WORMADAMTRASH, gMonShinyPalette_WormadamTrash),
    ...
    // SPECIES_SHINY_PAL(CHERRIMOVERCAST, gMonShinyPalette_CherrimOvercast),
    // SPECIES_SHINY_PAL(CHERRIMSUNSHINE, gMonShinyPalette_CherrimSunshine),
    SPECIES_SHINY_PAL(SHELLOSWEST, gMonShinyPalette_ShellosWest),
    SPECIES_SHINY_PAL(SHELLOSEAST, gMonShinyPalette_ShellosEast),
    SPECIES_SHINY_PAL(GASTRODONWEST, gMonShinyPalette_GastrodonWest),
    SPECIES_SHINY_PAL(GASTRODONEAST, gMonShinyPalette_GastrodonEast),
    ...
    // SPECIES_SHINY_PAL(ROTOMHEAT, gMonShinyPalette_RotomHeat),
    // SPECIES_SHINY_PAL(ROTOMWASH, gMonShinyPalette_RotomWash),
    // SPECIES_SHINY_PAL(ROTOMFROST, gMonShinyPalette_RotomFrost),
    // SPECIES_SHINY_PAL(ROTOMFAN, gMonShinyPalette_RotomFan),
    // SPECIES_SHINY_PAL(ROTOMMOW, gMonShinyPalette_RotomMow),
    ...
    // SPECIES_SHINY_PAL(GIRATINAALTERED, gMonShinyPalette_GiratinaAltered),
    // SPECIES_SHINY_PAL(GIRATINAORIGIN, gMonShinyPalette_GiratinaOrigin),
    ...
    // SPECIES_PAL(ARCEUSNORMAL, gMonShinyPalette_ArceusNormal),
    // SPECIES_PAL(ARCEUSFIGHTING, gMonShinyPalette_ArceusFighting),
    // SPECIES_PAL(ARCEUSFLYING, gMonShinyPalette_ArceusFlying),
    // SPECIES_PAL(ARCEUSPOISON, gMonShinyPalette_ArceusPoison),
    // SPECIES_PAL(ARCEUSGROUND, gMonShinyPalette_ArceusGround),
    // SPECIES_PAL(ARCEUSROCK, gMonShinyPalette_ArceusRock),
    // SPECIES_PAL(ARCEUSBUG, gMonShinyPalette_ArceusBug),
    // SPECIES_PAL(ARCEUSGHOST, gMonShinyPalette_ArceusGhost),
    // SPECIES_PAL(ARCEUSSTEEL, gMonShinyPalette_ArceusSteel),
    // SPECIES_PAL(ARCEUSFIRE, gMonShinyPalette_ArceusFire),
    // SPECIES_PAL(ARCEUSWATER, gMonShinyPalette_ArceusWater),
    // SPECIES_PAL(ARCEUSGRASS, gMonShinyPalette_ArceusGrass),
    // SPECIES_PAL(ARCEUSELECTRIC, gMonShinyPalette_ArceusElectric),
    // SPECIES_PAL(ARCEUSPSYCHIC, gMonShinyPalette_ArceusPsychic),
    // SPECIES_PAL(ARCEUSICE, gMonShinyPalette_ArceusIce),
    // SPECIES_PAL(ARCEUSDRAGON, gMonShinyPalette_ArceusDragon),
    // SPECIES_PAL(ARCEUSDARK, gMonShinyPalette_ArceusDark),
