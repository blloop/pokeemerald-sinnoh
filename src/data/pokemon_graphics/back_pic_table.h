const struct CompressedSpriteSheet gMonBackPicTable[] =
{
    ...
    SPECIES_SPRITE(BURMYPLANT, gMonBackPic_BurmyPlant),
    SPECIES_SPRITE(BURMYSANDY, gMonBackPic_BurmySandy),
    SPECIES_SPRITE(BURMYTRASH, gMonBackPic_BurmyTrash),
    SPECIES_SPRITE(WORMADAMPLANT, gMonBackPic_WormadamPlant),
    SPECIES_SPRITE(WORMADAMSANDY, gMonBackPic_WormadamSandy),
    SPECIES_SPRITE(WORMADAMTRASH, gMonBackPic_WormadamTrash),
    ...
    // SPECIES_SPRITE(CHERRIMOVERCAST, gMonBackPic_CherrimOvercast),
    // SPECIES_SPRITE(CHERRIMSUNSHINE, gMonBackPic_CherrimSunshine),
    SPECIES_SPRITE(SHELLOSWEST, gMonBackPic_ShellosWest),
    SPECIES_SPRITE(SHELLOSEAST, gMonBackPic_ShellosEast),
    SPECIES_SPRITE(GASTRODONWEST, gMonBackPic_GastrodonWest),
    SPECIES_SPRITE(GASTRODONEAST, gMonBackPic_GastrodonEast),
    ...
    SPECIES_SPRITE(HIPPOPOTASF, gMonBackPic_Hippopotas),
    SPECIES_SPRITE(HIPPOWDON, gMonBackPic_Hippowdon),
    SPECIES_SPRITE(HIPPOWDONF, gMonBackPic_Hippowdon),
    ...
    // SPECIES_SPRITE(ROTOMHEAT, gMonBackPic_RotomHeat),
    // SPECIES_SPRITE(ROTOMWASH, gMonBackPic_RotomWash),
    // SPECIES_SPRITE(ROTOMFROST, gMonBackPic_RotomFrost),
    // SPECIES_SPRITE(ROTOMFAN, gMonBackPic_RotomFan),
    // SPECIES_SPRITE(ROTOMMOW, gMonBackPic_RotomMow),
    ...
    // SPECIES_SPRITE(GIRATINAALTERED, gMonBackPic_GiratinaAltered),
    // SPECIES_SPRITE(GIRATINAORIGIN, gMonBackPic_GiratinaOrigin),
    ...
    SPECIES_SPRITE(SHAYMIN, gMonBackPic_ShayminLand),
    // SPECIES_SPRITE(SHAYMINLAND, gMonBackPic_ShayminLand),
    // SPECIES_SPRITE(SHAYMINSKY, gMonBackPic_ShayminSky),
    SPECIES_SPRITE(ARCEUS, gMonBackPic_Arceus),
    // SPECIES_SPRITE(ARCEUSNORMAL, gMonBackPic_Arceus),
    // SPECIES_SPRITE(ARCEUSFIGHTING, gMonBackPic_Arceus),
    // SPECIES_SPRITE(ARCEUSFLYING, gMonBackPic_Arceus),
    // SPECIES_SPRITE(ARCEUSPOISON, gMonBackPic_Arceus),
    // SPECIES_SPRITE(ARCEUSGROUND, gMonBackPic_Arceus),
    // SPECIES_SPRITE(ARCEUSROCK, gMonBackPic_Arceus),
    // SPECIES_SPRITE(ARCEUSBUG, gMonBackPic_Arceus),
    // SPECIES_SPRITE(ARCEUSGHOST, gMonBackPic_Arceus),
    // SPECIES_SPRITE(ARCEUSSTEEL, gMonBackPic_Arceus),
    // SPECIES_SPRITE(ARCEUSFIRE, gMonBackPic_Arceus),
    // SPECIES_SPRITE(ARCEUSWATER, gMonBackPic_Arceus),
    // SPECIES_SPRITE(ARCEUSGRASS, gMonBackPic_Arceus),
    // SPECIES_SPRITE(ARCEUSELECTRIC, gMonBackPic_Arceus),
    // SPECIES_SPRITE(ARCEUSPSYCHIC, gMonBackPic_Arceus),
    // SPECIES_SPRITE(ARCEUSICE, gMonBackPic_Arceus),
    // SPECIES_SPRITE(ARCEUSDRAGON, gMonBackPic_Arceus),
    // SPECIES_SPRITE(ARCEUSDARK, gMonBackPic_Arceus),
