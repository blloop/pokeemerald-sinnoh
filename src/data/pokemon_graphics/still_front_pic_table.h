...
// Gen IV
    ...
    SPECIES_SPRITE(BURMYPLANT,      gMonStillFrontPic_BurmyPlant),
    SPECIES_SPRITE(BURMYSANDY,      gMonStillFrontPic_BurmySandy),
    SPECIES_SPRITE(BURMYTRASH,      gMonStillFrontPic_BurmyTrash),
    SPECIES_SPRITE(WORMADAMPLANT,   gMonStillFrontPic_WormadamPlant),
    SPECIES_SPRITE(WORMADAMSANDY,   gMonStillFrontPic_WormadamSandy),
    SPECIES_SPRITE(WORMADAMTRASH,   gMonStillFrontPic_WormadamTrash),
    ...
    // SPECIES_SPRITE(CHERRIMOVERCAST, gMonStillFrontPic_CherrimOvercast),
    // SPECIES_SPRITE(CHERRIMSUNSHINE, gMonStillFrontPic_CherrimSunshine),
    SPECIES_SPRITE(SHELLOSWEST,     gMonStillFrontPic_ShellosWest),
    SPECIES_SPRITE(SHELLOSEAST,     gMonStillFrontPic_ShellosEast),
    SPECIES_SPRITE(GASTRODONWEST,   gMonStillFrontPic_GastrodonWest),
    SPECIES_SPRITE(GASTRODONEAST,   gMonStillFrontPic_GastrodonEast),
    ...
    SPECIES_SPRITE(HIPPOPOTASF,     gMonStillFrontPic_Hippopotas),
    SPECIES_SPRITE(HIPPOWDON,       gMonStillFrontPic_Hippowdon),
    SPECIES_SPRITE(HIPPOWDONF,      gMonStillFrontPic_Hippowdon),
    ...
    // SPECIES_SPRITE(ROTOMHEAT,       gMonStillFrontPic_RotomHeat),
    // SPECIES_SPRITE(ROTOMWASH,       gMonStillFrontPic_RotomWash),
    // SPECIES_SPRITE(ROTOMFROST,      gMonStillFrontPic_RotomFrost),
    // SPECIES_SPRITE(ROTOMFAN,        gMonStillFrontPic_RotomFan),
    // SPECIES_SPRITE(ROTOMMOW,        gMonStillFrontPic_RotomMow),
    ...
    // SPECIES_SPRITE(GIRATINAALTERED, gMonStillFrontPic_GiratinaAltered),
    // SPECIES_SPRITE(GIRATINAORIGIN,  gMonStillFrontPic_GiratinaOrigin),
    ...
    // SPECIES_SPRITE(SHAYMINLAND,     gMonStillFrontPic_ShayminLand),
    // SPECIES_SPRITE(SHAYMINSKY,      gMonStillFrontPic_ShayminSky),
    SPECIES_SPRITE(ARCEUS,          gMonStillFrontPic_Arceus),
    // SPECIES_SPRITE(ARCEUSNORMAL,    gMonStillFrontPic_Arceus),
    // SPECIES_SPRITE(ARCEUSFIGHTING,  gMonStillFrontPic_Arceus),
    // SPECIES_SPRITE(ARCEUSFLYING,    gMonStillFrontPic_Arceus),
    // SPECIES_SPRITE(ARCEUSPOISON,    gMonStillFrontPic_Arceus),
    // SPECIES_SPRITE(ARCEUSGROUND,    gMonStillFrontPic_Arceus),
    // SPECIES_SPRITE(ARCEUSROCK,      gMonStillFrontPic_Arceus),
    // SPECIES_SPRITE(ARCEUSBUG,       gMonStillFrontPic_Arceus),
    // SPECIES_SPRITE(ARCEUSGHOST,     gMonStillFrontPic_Arceus),
    // SPECIES_SPRITE(ARCEUSSTEEL,     gMonStillFrontPic_Arceus),
    // SPECIES_SPRITE(ARCEUSFIRE,      gMonStillFrontPic_Arceus),
    // SPECIES_SPRITE(ARCEUSWATER,     gMonStillFrontPic_Arceus),
    // SPECIES_SPRITE(ARCEUSGRASS,     gMonStillFrontPic_Arceus),
    // SPECIES_SPRITE(ARCEUSELECTRIC,  gMonStillFrontPic_Arceus),
    // SPECIES_SPRITE(ARCEUSPSYCHIC,   gMonStillFrontPic_Arceus),
    // SPECIES_SPRITE(ARCEUSICE,       gMonStillFrontPic_Arceus),
    // SPECIES_SPRITE(ARCEUSDRAGON,    gMonStillFrontPic_Arceus),
    // SPECIES_SPRITE(ARCEUSDARK,      gMonStillFrontPic_Arceus),
// Misc
