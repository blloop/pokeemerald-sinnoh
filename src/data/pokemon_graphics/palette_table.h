const struct CompressedSpritePalette gMonPaletteTable[] =
{
    ...
    SPECIES_PAL(BURMYPLANT, gMonPalette_BurmyPlant),
    SPECIES_PAL(BURMYSANDY, gMonPalette_BurmySandy),
    SPECIES_PAL(BURMYTRASH, gMonPalette_BurmyTrash),
    SPECIES_PAL(WORMADAMPLANT, gMonPalette_WormadamPlant),
    SPECIES_PAL(WORMADAMSANDY, gMonPalette_WormadamSandy),
    SPECIES_PAL(WORMADAMTRASH, gMonPalette_WormadamTrash),
    ...
    // SPECIES_PAL(CHERRIMOVERCAST, gMonPalette_CherrimOvercast),
    // SPECIES_PAL(CHERRIMSUNSHINE, gMonPalette_CherrimSunshine),
    SPECIES_PAL(SHELLOSWEST, gMonPalette_ShellosWest),
    SPECIES_PAL(SHELLOSEAST, gMonPalette_ShellosEast),
    SPECIES_PAL(GASTRODONWEST, gMonPalette_GastrodonWest),
    SPECIES_PAL(GASTRODONEAST, gMonPalette_GastrodonEast),
    ...
    // SPECIES_PAL(ROTOMHEAT, gMonPalette_RotomHeat),
    // SPECIES_PAL(ROTOMWASH, gMonPalette_RotomWash),
    // SPECIES_PAL(ROTOMFROST, gMonPalette_RotomFrost),
    // SPECIES_PAL(ROTOMFAN, gMonPalette_RotomFan),
    // SPECIES_PAL(ROTOMMOW, gMonPalette_RotomMow),
    ...
    // SPECIES_PAL(GIRATINAALTERED, gMonPalette_GiratinaAltered),
    // SPECIES_PAL(GIRATINAORIGIN, gMonPalette_GiratinaOrigin),
    ...
    // SPECIES_PAL(ARCEUSNORMAL, gMonPalette_ArceusNormal),
    // SPECIES_PAL(ARCEUSFIGHTING, gMonPalette_ArceusFighting),
    // SPECIES_PAL(ARCEUSFLYING, gMonPalette_ArceusFlying),
    // SPECIES_PAL(ARCEUSPOISON, gMonPalette_ArceusPoison),
    // SPECIES_PAL(ARCEUSGROUND, gMonPalette_ArceusGround),
    // SPECIES_PAL(ARCEUSROCK, gMonPalette_ArceusRock),
    // SPECIES_PAL(ARCEUSBUG, gMonPalette_ArceusBug),
    // SPECIES_PAL(ARCEUSGHOST, gMonPalette_ArceusGhost),
    // SPECIES_PAL(ARCEUSSTEEL, gMonPalette_ArceusSteel),
    // SPECIES_PAL(ARCEUSFIRE, gMonPalette_ArceusFire),
    // SPECIES_PAL(ARCEUSWATER, gMonPalette_ArceusWater),
    // SPECIES_PAL(ARCEUSGRASS, gMonPalette_ArceusGrass),
    // SPECIES_PAL(ARCEUSELECTRIC, gMonPalette_ArceusElectric),
    // SPECIES_PAL(ARCEUSPSYCHIC, gMonPalette_ArceusPsychic),
    // SPECIES_PAL(ARCEUSICE, gMonPalette_ArceusIce),
    // SPECIES_PAL(ARCEUSDRAGON, gMonPalette_ArceusDragon),
    // SPECIES_PAL(ARCEUSDARK, gMonPalette_ArceusDark),
