...
const union AnimCmd *const *const gMonFrontAnimsPtrTable[] =
{
    ...
    [SPECIES_HONCHCROW]       = sAnims_Honchcrow,
    ...
    [SPECIES_HIPPOPOTASF]     = sAnims_Hippopotas,
    [SPECIES_HIPPOWDON]       = sAnims_Hippowdon,
    [SPECIES_HIPPOWDONF]      = sAnims_Hippowdon,
