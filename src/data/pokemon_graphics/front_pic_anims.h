...
static const union AnimCmd sAnim_ShellosWestSea_1[] =
{
    ANIMCMD_FRAME(0, 1),
    ANIMCMD_FRAME(1, 36),
    ANIMCMD_FRAME(0, 10),
...
static const union AnimCmd sAnim_GastrodonWestSea_1[] =
{
    ANIMCMD_FRAME(1, 15),
    ANIMCMD_FRAME(0, 15),
    ANIMCMD_FRAME(1, 15),
...
SINGLE_ANIMATION(ShellosWestSea);
SINGLE_ANIMATION(ShellosEast);
SINGLE_ANIMATION(GastrodonWestSea);
...
const union AnimCmd *const *const gMonFrontAnimsPtrTable[] =
{
    ...
    [SPECIES_SHELLOSWESTSEA]   = sAnims_ShellosWestSea,
    [SPECIES_SHELLOSEAST]      = sAnims_ShellosEast,
    [SPECIES_GASTRODONWESTSEA] = sAnims_GastrodonWestSea,
