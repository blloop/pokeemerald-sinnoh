const struct CompressedSpriteSheet gMonFrontPicTable[] =
{
    ...
    SPECIES_SPRITE(BURMYPLANT, gMonFrontPic_BurmyPlant),
    SPECIES_SPRITE(BURMYSANDY, gMonFrontPic_BurmySandy),
    SPECIES_SPRITE(BURMYTRASH, gMonFrontPic_BurmyTrash),
    SPECIES_SPRITE(WORMADAMPLANT, gMonFrontPic_WormadamPlant),
    SPECIES_SPRITE(WORMADAMSANDY, gMonFrontPic_WormadamSandy),
    SPECIES_SPRITE(WORMADAMTRASH, gMonFrontPic_WormadamTrash),
    ...
    // SPECIES_SPRITE(CHERRIMOVERCAST, gMonFrontPic_CherrimOvercast),
    // SPECIES_SPRITE(CHERRIMSUNSHINE, gMonFrontPic_CherrimSunshine),
    SPECIES_SPRITE(SHELLOSWEST, gMonFrontPic_ShellosWest),
    SPECIES_SPRITE(SHELLOSEAST, gMonFrontPic_ShellosEast),
    SPECIES_SPRITE(GASTRODONWEST, gMonFrontPic_GastrodonWest),
    SPECIES_SPRITE(GASTRODONEAST, gMonFrontPic_GastrodonEast),
    ...
    SPECIES_SPRITE(HIPPOPOTASF, gMonFrontPic_Hippopotas),
    SPECIES_SPRITE(HIPPOWDON, gMonFrontPic_Hippowdon),
    SPECIES_SPRITE(HIPPOWDONF, gMonFrontPic_Hippowdon),
    ...
    // SPECIES_SPRITE(ROTOMHEAT, gMonFrontPic_RotomHeat),
    // SPECIES_SPRITE(ROTOMWASH, gMonFrontPic_RotomWash),
    // SPECIES_SPRITE(ROTOMFROST, gMonFrontPic_RotomFrost),
    // SPECIES_SPRITE(ROTOMFAN, gMonFrontPic_RotomFan),
    // SPECIES_SPRITE(ROTOMMOW, gMonFrontPic_RotomMow),
    ...
    // SPECIES_SPRITE(GIRATINAALTERED, gMonFrontPic_GiratinaAltered),
    // SPECIES_SPRITE(GIRATINAORIGIN, gMonFrontPic_GiratinaOrigin),
    ...
    // SPECIES_SPRITE(SHAYMINLAND, gMonFrontPic_ShayminLand),
    // SPECIES_SPRITE(SHAYMINSKY, gMonFrontPic_ShayminSky),
    SPECIES_SPRITE(ARCEUS, gMonFrontPic_Arceus),
    // SPECIES_SPRITE(ARCEUSNORMAL, gMonFrontPic_Arceus),
    // SPECIES_SPRITE(ARCEUSFIGHTING, gMonFrontPic_Arceus),
    // SPECIES_SPRITE(ARCEUSFLYING, gMonFrontPic_Arceus),
    // SPECIES_SPRITE(ARCEUSPOISON, gMonFrontPic_Arceus),
    // SPECIES_SPRITE(ARCEUSGROUND, gMonFrontPic_Arceus),
    // SPECIES_SPRITE(ARCEUSROCK, gMonFrontPic_Arceus),
    // SPECIES_SPRITE(ARCEUSBUG, gMonFrontPic_Arceus),
    // SPECIES_SPRITE(ARCEUSGHOST, gMonFrontPic_Arceus),
    // SPECIES_SPRITE(ARCEUSSTEEL, gMonFrontPic_Arceus),
    // SPECIES_SPRITE(ARCEUSFIRE, gMonFrontPic_Arceus),
    // SPECIES_SPRITE(ARCEUSWATER, gMonFrontPic_Arceus),
    // SPECIES_SPRITE(ARCEUSGRASS, gMonFrontPic_Arceus),
    // SPECIES_SPRITE(ARCEUSELECTRIC, gMonFrontPic_Arceus),
    // SPECIES_SPRITE(ARCEUSPSYCHIC, gMonFrontPic_Arceus),
    // SPECIES_SPRITE(ARCEUSICE, gMonFrontPic_Arceus),
    // SPECIES_SPRITE(ARCEUSDRAGON, gMonFrontPic_Arceus),
    // SPECIES_SPRITE(ARCEUSDARK, gMonFrontPic_Arceus),
