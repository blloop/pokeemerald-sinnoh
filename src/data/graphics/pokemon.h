...
const u32 gMonStillFrontPic_ShellosWestSea[] = INCBIN_U32("graphics/pokemon/shellos/front.4bpp.lz");
...
const u32 gMonStillFrontPic_GastrodonWestSea[] = INCBIN_U32("graphics/pokemon/gastrodon/front.4bpp.lz");
