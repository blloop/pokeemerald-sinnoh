...
const u16 gEasyChatWordsByLetter_A[] = {
    ...
    EC_WORD_AT,
    EC_WORD_ATTACK,
    EC_MOVE2(ATTACK_ORDER),
    EC_MOVE2(ATTRACT),
    EC_WORD_AUNT,
    EC_MOVE2(AURA_SPHERE),
    EC_MOVE(AURORA_BEAM),
    EC_MOVE2(AVALANCHE),
    EC_WORD_AVANT_GARDE,
    EC_WORD_AWAY,
...
const u16 gEasyChatWordsByLetter_B[] = {
    ...
    EC_MOVE2(BULLET_PUNCH),
    EC_POKEMON(BUNEARY),
    EC_POKEMON(BURMYPLANT),
    EC_WORD_BUSY,
    EC_WORD_BUT,
...
const u16 gEasyChatWordsByLetter_F[] = {
    ...
    EC_MOVE2(FLARE_BLITZ),
    EC_POKEMON_NATIONAL(FLAREON),
    EC_MOVE2(FLASH),
    EC_MOVE2(FLASH_CANNON),
    EC_WORD_FLASH_FIRE,
    EC_WORD_FLATTEN,
    EC_MOVE(FLATTER),
    EC_MOVE2(FLING),
...
const u16 gEasyChatWordsByLetter_G[] = {
    ...
    EC_POKEMON(GASTLY),
    EC_MOVE2(GASTRO_ACID),
    EC_POKEMON(GASTRODONWEST),
    EC_POKEMON(GENGAR),
    EC_WORD_GENIUS,
    DOUBLE_SPECIES_NAME
    EC_POKEMON(GEODUDE),
...
const u16 gEasyChatWordsByLetter_H[] = {
    ...
    EC_WORD_HIM,
    EC_WORD_HIP_AND,
    EC_POKEMON(HIPPOPOTAS),
    EC_POKEMON(HIPPOWDON),
    EC_WORD_HIS,
    EC_WORD_HIT,
...
const u16 gEasyChatWordsByLetter_P[] = {
    ...
    EC_POKEMON_NATIONAL(PORYGONZ),
    EC_MOVE2(POUND),
    EC_MOVE(POWDER_SNOW),
    EC_WORD_POWER,
    EC_MOVE2(POWER_GEM),
    EC_MOVE2(POWER_SWAP),
    EC_MOVE2(POWER_TRICK),
    EC_MOVE2(POWER_WHIP),
    EC_WORD_PRAISE,
...
const u16 gEasyChatWordsByLetter_R[] = {
    ...
    EC_WORD_RIVAL,
    EC_MOVE2(ROAR),
    EC_MOVE2(ROAR_OF_TIME),
    EC_WORD_ROCK,
    EC_MOVE2(ROCK_BLAST),
    EC_MOVE2(ROCK_CLIMB),
    EC_WORD_ROCK_HEAD,
    EC_MOVE2(ROCK_POLISH),
    EC_MOVE(ROCK_SLIDE),
    EC_MOVE(ROCK_SMASH),
    EC_MOVE(ROCK_THROW),
    EC_MOVE(ROCK_TOMB),
    EC_WORD_ROCK_SOLID,
    EC_MOVE2(ROCK_WRECKER),
    EC_MOVE2(ROLE_PLAY),
...
const u16 gEasyChatWordsByLetter_S[] = {
    ...
    EC_MOVE(SHADOW_BALL),
    EC_MOVE2(SHADOW_CLAW),
    EC_MOVE2(SHADOW_FORCE),
    EC_MOVE(SHADOW_PUNCH),
    EC_MOVE2(SHADOW_SNEAK),
    EC_WORD_SHADOW_TAG,
    EC_WORD_SHADY,
    EC_WORD_SHAKE,
    EC_WORD_SHAKY,
